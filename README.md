...
---
### [PulseSuite](https://github.com/rahulranjansah/pulsesuite)
PulseSuite is a high-performance computational physics toolkit for simulating ultrafast laser-matter interactions in semiconductor quantum structures. It implements the Semiconductor Bloch Equations (SBEs) coupled with Pseudo-Spectral Time Domain (PSTD) electromagnetic field propagation methods to model quantum wire and quantum well systems under intense optical excitation. Documentation is available [here](https://pulsesuite.readthedocs.io/en/latest/).

<div align="center">
  <img src="https://pulsesuite.readthedocs.io/en/latest/_images/PulseSuitenobg.png" width="48%" />
  <br />
  <em></em>
</div>
